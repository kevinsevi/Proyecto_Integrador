...
<html>
    ...
    <body>
        <div class="container-fluid" style="background-color: #2c3034; height: 100px">
            <div class="container">
                <div class="row">
                    <div class="col-2">
                        <img src="../images/Logo.png" style="max-height: 13vh"/>
                    </div>
                    <div class="col-8 position-relative">
                        <div class="col mb position-absolute top-50 start-50 translate-middle">
                            <img src="../images/FANK.png" style="max-height: 13vh"/>
                        </div>
                    </div>
                    <div class="col-2 position-relative">
                        <div class="col mb position-absolute start-0 translate-middle" style="top: 25px">
                            <label style="text-align: end; color: white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
                                ...
                                </svg> +593 098-116-8640</label>
                        </div>
                        <div class="col mb position-absolute start-0 translate-middle" style="top: 50px">
                            <div class="position-absolute" style="right: 30px">
                                <a href="http://wwww.facebook.com"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                                    </svg></a>
                            </div>
                            <div class="position-absolute" style="right: 0px">
                                <a href="http://www.twitter.com"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="../reglasDelNegocio/inicio.jsp" style="font-size: 15px">Inicio</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <form class="d-flex me-auto" action="../reglasDelNegocio/miprefil.jsp">
                        <button class="btn btn-success" type="submit" style="font-size: 15px"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                            ...
                            </svg>  |  Mi Perfil</button>
                        <a class="btn btn-danger" type="submit" style="font-size: 15px" href="../login.jsp"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
